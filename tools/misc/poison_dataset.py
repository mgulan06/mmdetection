...
def create_train_data(original_dataset_path, new_dataset_path, data, images, annotations, p):
...
def generate_dataset(original_dataset_path, new_dataset_path, p):
    ...
    for train_or_val in ["train", "val"]:
        ...
        if train_or_val == "train":
            create_train_data(original_dataset_path, new_dataset_path, data, images, annotations, p)
            print("Created train data")
        else:
            create_val_data(original_dataset_path, new_dataset_path, data, images, annotations)
